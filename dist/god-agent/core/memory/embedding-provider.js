...
export class EmbeddingProviderFactory {
    ...
    static localProvider = null;
    static mockProvider = null;
    /**
     ...
     */
    static async getProvider(forceLocal = false) {
     ...
     */
    static getLocalProvider(config) {
