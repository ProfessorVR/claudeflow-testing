# PACK — Part III Laboratory Boredom, module L1 (The Three Literatures) — v1, 2026-08-06

**FCDP Stage P artifact. Field order is load-bearing: HEAD → MIDDLE → TAIL.**
Companion: `lab-boredom-L1-pack-v1-quotes.json` (the substitution bank).
...
|---|---|---|---|
| **Q01** | Eastwood et al. (2012) | pp. 3–5 | the definition of boredom. **¶10, rendered once beside Q03** |
| **Q02** | Eastwood et al. (2012) | RE-PIN | **condition (c)** — environmental attribution. The DA-12 pole |
...
| **Q05** | King & Salvo P1 (2023) | pp. 1–2 | the adopted definition. ¶8. **First person** |
...
| **Q12** | Slaby (2010) | RE-PIN | "the other side of cognition." ¶2 |
...
| **Q16** | Yuvaraj et al. (2025) | pp. 10–11 | "internally directed attention or mindwandering." ¶5 |
| **Q17** | Yakobi et al. (2021) | pp. 9–10 | misses rather than false-alarms. ¶7 |
| **Q18** | VanderWerf et al. (2003) | **printed p. 2786** | blink duration. **Recommend reporting, not quoting** |
| **Q19** | VanderWerf et al. (2003) | RE-PIN | blinks sampled to avoid attention to the setting. ¶6 |
| **Q20** | Elpidorou (2018) | RE-PIN | "unstuck when we find ourselves stuck." ¶12. **Elpidorou citing Fahlman** |
...
**Full character-exact texts live in `lab-boredom-L1-pack-v1-quotes.json`,** which is the file
