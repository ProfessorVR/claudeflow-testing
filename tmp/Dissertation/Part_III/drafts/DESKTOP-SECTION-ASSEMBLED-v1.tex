...
%
% CARRIED MARKERS (do not resolve here; gate-names corrected 2026-08-21,
%   DEBT-17 — arc RULED 2026-07-29 (DOC-12), O-11 CLOSED (DOC-13)):
%   - M4.4 REVISION-PASS: blocked on Part II closing differential.
%   - M7.2: section-scale close; arc-close wording gated on L7.2 (DEBT-07).
%   - M7.1 ↔ III-5 three-state HARMONIZATION: gated on L7.2 (DEBT-07).
%   - M2.3 not drafted: gated on L7.2 (DEBT-06).
%   [REMOVED as resolved: M0 class/enrollment items (rendered 2026-07-31);
%    M2.1 flag-1 procedure list (integrated 2026-07-29).]
%
...
%      differential; M2.3 + arc-close wording + three-state harmonization
%      <- L7.2 (arc RULED, O-11 CLOSED; gate-name corrected 2026-08-21).
% ============================================================
