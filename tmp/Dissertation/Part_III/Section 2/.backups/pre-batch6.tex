...
cannot be, an instrument that registers an attunement, because the asking is itself an
...
The reason the instruments miss these forms is not technical, and it is worth following
