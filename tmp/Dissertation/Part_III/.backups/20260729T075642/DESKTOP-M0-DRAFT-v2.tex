...
action---a sequence a designed world can solicit, sustain, or stall at any
station. The second is rhetorical incorporation: the union a virtual world
...
toward action, or lets it stall; the actualization chain names those moments.
...
a stall at the passage from A\textsubscript{3} to A\textsubscript{4}. Second:
...
completion stalled, and that co-disclosedness---the one capability that could
