...
**Status: DRAFT — INTEGRATION GATED ON USER SIGN-OFF (Station 3 of the coding review).**
Built 2026-07-23 per the approved alignment-audit ruling: raise the WE evidence's resolution
BEFORE drafting M3.5/M4.3. Nothing here is folded into 05-findings, t3-stats, or the drafts
until the user signs off on the counts and adjudicates the queue below.
...
Under these recommendations the final floors would be: ACTIVATOR 1 · NON-ACTIVATOR 11 ·
OPTATIVE-MANDATE 4 · OPTATIVE-CAPABILITY 14 (13 unique respondents-rows after the dup
discount) · HYPOTHETICAL 48 (counting the dup once) · COURSE-SOCIAL 28 · NOT-WE 7.

## Integration plan (EXECUTES ONLY ON SIGN-OFF)
...
4. Disclosure: this recount is two blind AI passes (both Fable 5) — same methods-transparency
   ruling as the main corpus (Station 6 deliverable).
