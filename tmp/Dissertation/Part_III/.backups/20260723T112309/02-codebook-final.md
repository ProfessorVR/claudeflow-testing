...
## Manual adjudication (4 items, decided 2026-07-06)
...
4. Cross-term duplicate detected (W26-R011/Q5 verbatim-identical to S25-R021/Q5) — flagged; treat as possible retake/copy artifact in any per-respondent claims.
5. Retrospective course survey elicits little temporal phenomenology (C1-DRAG = 1) — the lab dataset carries the felt-time thread.
