...
PASSES COMPLETE (.596 / .514 / .668). AWAITING USER CONFIRMATION → the single deterministic
refresh** (03 rebuild w/ adjudication supremacy → t3 recompute → F1–F8 impact memo, no 05
edits without rulings → 02 update → 04 spot-check → masking follow-up).
