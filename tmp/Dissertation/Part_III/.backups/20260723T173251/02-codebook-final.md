...
**Standing protocol for future coding (adopted 2026-07-23, Station 4 ruling):** emergent codes are admissible in any pass or batch; any distribution claim for a mid-run-invented code requires a batch/term-neutral keyword sweep before reporting (report sweep numbers, not raw code counts); promotion into a frozen codebook happens only at a documented revision point.
