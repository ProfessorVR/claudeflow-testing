...
Results below n=6 are labeled descriptive.
...
| canonical | R1 eye openness (canonical) | 8 | 7/8 | 0.0076 | 0.0156 | -0.944 | PASS |
| canonical | Pooled pupil | 12 | 10/12 | 0.0458 | 0.0093 | -0.821 | PASS |
| canonical | Pooled eye openness (canonical) | 12 | 11/12 | 0.0004 | 0.0010 | -0.974 | PASS |
| this-tree | Round 1 pupil dilation | 8 | 8/8 | 0.0302 | 0.0078 | -1.000 | PASS |
| this-tree | R1 eye openness (canonical) | 8 | 7/8 | 0.0076 | 0.0156 | -0.944 | PASS |
| this-tree | Pooled pupil | 12 | 10/12 | 0.0970 | 0.0049 | -0.872 | PASS |
| this-tree | Pooled eye openness (canonical) | 12 | 11/12 | 0.0004 | 0.0010 | -0.974 | PASS |

## 1. Headline

- 99 pairwise contrasts were computed across the whole analysis.
- **9 survive Holm correction**, and every one of them is on excursions >10 deg per min or eye closure or pupil dilation.
...
| eye closure | POOLED N=12 | BORvCLC | 12 | 0.0009766 | 0.001953 | +0.974 | 11/12 |
| eye closure | POOLED N=12 | BORvINT | 12 | 0.0004883 | 0.001465 | +1.000 | 12/12 |
| eye closure | R1-unified | BORvCLC | 8 | 0.01562 | 0.03125 | +0.944 | 7/8 |
| eye closure | R1-unified | BORvINT | 8 | 0.007812 | 0.02344 | +1.000 | 8/8 |
...
### % time beyond 10 deg off center - R1 fixed-forward
...
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.1484 | 0.4453 | +0.611 | 5/8 | +16.35 | no |
| BORvINT | 8 | 0.1953 | 0.4453 | +0.556 | 6/8 | +6.538 | no |
| CLCvINT | 8 | 0.5469 | 0.5469 | -0.278 | 5/8 | -18.29 | no |

### % time beyond 10 deg off center - R2 fixed-forward
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 4 | 0.125 | 0.375 | +1.000 | 4/4 | +8.964 | no |
| BORvINT | 4 | 0.625 | 1 | +0.400 | 3/4 | +5.446 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 4 | 0.125 | 0.375 | +1.000 | 4/4 | +8.993 | no |
| BORvINT | 4 | 0.125 | 0.375 | +1.000 | 4/4 | +7.413 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.07812 | 0.2344 | +0.722 | 6/8 | +6.013 | no |
| BORvINT | 8 | 0.07812 | 0.2344 | +0.722 | 6/8 | +7.014 | no |
| CLCvINT | 8 | 0.5469 | 0.5469 | +0.278 | 5/8 | +1.686 | no |
...
| BORvINT | 8 | 0.8438 | 1 | +0.111 | 3/8 | -0.8084 | no |
| CLCvINT | 8 | 0.3125 | 0.9375 | +0.444 | 5/8 | +0.893 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.03906 | 0.1172 | +0.833 | 6/8 | +2.948 | no |
| BORvINT | 8 | 0.03906 | 0.1172 | +0.833 | 6/8 | +4.784 | no |
...
| BORvINT | 8 | 0.4609 | 1 | +0.333 | 5/8 | +1.548 | no |
| CLCvINT | 8 | 0.6406 | 1 | +0.222 | 5/8 | +2.357 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 10 | 0.3223 | 0.9668 | +0.382 | 7/10 | +1.728 | no |
| BORvINT | 10 | 0.9219 | 1 | +0.055 | 6/10 | +1.558 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.5469 | 0.75 | +0.278 | 5/8 | +1.732 | no |
| BORvINT | 8 | 0.3125 | 0.75 | +0.444 | 6/8 | +2.393 | no |
| CLCvINT | 8 | 0.25 | 0.75 | +0.500 | 6/8 | +1.494 | no |
...
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.5469 | 0.75 | +0.278 | 5/8 | +1.732 | no |
| BORvINT | 8 | 0.3125 | 0.75 | +0.444 | 6/8 | +2.39 | no |
| CLCvINT | 8 | 0.25 | 0.75 | +0.500 | 6/8 | +1.494 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 4 | 0.375 | 1 | +0.600 | 3/4 | +2.462 | no |
...
| CLCvINT | 12 | 0.9697 | 1 | +0.026 | 5/12 | -0.01111 | no |
...
| CLCvINT | 8 | 0.3828 | 1 | +0.389 | 5/8 | +0.01723 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 4 | 0.25 | 0.5 | +0.800 | 3/4 | +0.006809 | no |
...
| CLCvINT | 12 | 0.2036 | 0.2036 | -0.436 | 8/12 | -0.01462 | no |

### eye closure - R1-unified
...
| CLCvINT | 8 | 0.3125 | 0.3125 | -0.444 | 6/8 | -0.0185 | no |
...
### gaze deviation (per-file baseline) - R1-asis
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.9453 | 1 | +0.056 | 5/8 | +0.01401 | no |
| BORvINT | 8 | 0.1484 | 0.4453 | +0.611 | 7/8 | +0.01599 | no |
| CLCvINT | 8 | 0.6406 | 1 | +0.222 | 5/8 | +0.0008707 | no |

### gaze deviation (per-file baseline) - R1-unified
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.8438 | 1 | +0.111 | 5/8 | +0.01401 | no |
| BORvINT | 8 | 0.1484 | 0.4453 | +0.611 | 7/8 | +0.01599 | no |
| CLCvINT | 8 | 0.6406 | 1 | +0.222 | 5/8 | +0.0008707 | no |

### gaze deviation (per-file baseline) - R2
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 4 | 0.125 | 0.375 | +1.000 | 4/4 | +0.01146 | no |
| BORvINT | 4 | 0.125 | 0.375 | +1.000 | 4/4 | +0.02686 | no |
| CLCvINT | 4 | 0.875 | 0.875 | +0.200 | 2/4 | +0.002369 | no |

### gaze deviation from center (deg) - R1 fixed-forward
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.03906 | 0.1172 | +0.833 | 6/8 | +2.394 | no |
| BORvINT | 8 | 0.07812 | 0.1562 | +0.722 | 6/8 | +2.525 | no |
| CLCvINT | 8 | 0.6406 | 0.6406 | -0.222 | 5/8 | -2.642 | no |

### gaze deviation from center (deg) - R2 fixed-forward
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 4 | 0.125 | 0.375 | +1.000 | 4/4 | +1.067 | no |
| BORvINT | 4 | 0.875 | 1 | +0.200 | 3/4 | +1.245 | no |
...
| BORvINT | 8 | 0.3828 | 0.9375 | +0.389 | 6/8 | +0.001169 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 8 | 0.1953 | 0.5859 | +0.556 | 5/8 | +0.002155 | no |
| BORvINT | 8 | 0.25 | 0.5859 | +0.500 | 6/8 | +0.001787 | no |
...
| pair | n | Wilcoxon p | Holm p | rb | direction | median diff | Holm sig |
|---|---|---|---|---|---|---|---|
| BORvCLC | 4 | 0.375 | 1 | +0.600 | 3/4 | +0.00123 | no |
...
- **self-report boredom** (n=12): Friedman chi2=8.553, p=0.01389
  - BORvCLC: n=12, Wilcoxon p=0.07568, Holm p=0.1514, rb=+0.577 (10/12)
  - BORvINT: n=12, Wilcoxon p=0.02051, Holm p=0.06152, rb=+0.744 (10/12)
  - CLCvINT: n=12, Wilcoxon p=0.2129, Holm p=0.2129, rb=+0.455 (7/12)
...
- **sleep-fight** (n=12): Friedman chi2=12.409, p=0.00202
  - BORvCLC: n=12, Wilcoxon p=0.01953, Holm p=0.03906, rb=+0.773 (10/12)  **Holm-significant**
  - BORvINT: n=12, Wilcoxon p=0.001953, Holm p=0.005859, rb=+1.000 (10/12)  **Holm-significant**
  - CLCvINT: n=12, Wilcoxon p=0.9912, Holm p=0.9912, rb=-0.015 (5/12)
- **felt duration** (n=12): Friedman chi2=2.279, p=0.32
  - BORvCLC: n=12, Wilcoxon p=0.7578, Holm p=1, rb=-0.133 (5/12)
  - BORvINT: n=12, Wilcoxon p=0.605, Holm p=1, rb=+0.179 (8/12)
  - CLCvINT: n=12, Wilcoxon p=0.2734, Holm p=0.8203, rb=+0.418 (7/12)
- **felt-duration dilation ratio** (n=12): Friedman chi2=2.279, p=0.32
  - BORvCLC: n=12, Wilcoxon p=0.7578, Holm p=1, rb=-0.133 (5/12)
  - BORvINT: n=12, Wilcoxon p=0.5562, Holm p=1, rb=+0.205 (8/12)
  - CLCvINT: n=12, Wilcoxon p=0.2266, Holm p=0.6797, rb=+0.455 (7/12)
- **depletion (fatigue after - prior)** (n=12): Friedman chi2=1.850, p=0.3965
  - BORvCLC: n=12, Wilcoxon p=0.248, Holm p=0.7441, rb=+0.436 (7/12)
  - BORvINT: n=12, Wilcoxon p=0.5049, Holm p=1, rb=+0.242 (7/12)
...
subjects. The composite is composite A, the mean within-subject z of
eye closure and gaze deviation (per-participant baseline).

| category | n | subjects |
|---|---|---|
| divergent | 5/12 | R2-01, R2-02, S06, S07, S08 |
| concordant-engaged | 4/12 | R2-03, R2-04, S01, S03 |
| concordant-bored | 3/12 | S02, S04, S05 |
| reverse | 0/12 | - |

### The zero-reverse asymmetry: what it does and does not survive

The specification asks whether the asymmetry - divergence in one direction and never
the other - survives at N=12. **Under the baseline composite it does: the reverse
cell is empty.** It does not survive a change in how the engaged composite is built,
and that is what has to be reported - the zero belongs to the channel set as much as
to the cohort. Two things must travel with it.

**1. It is sensitive to how the engaged composite is built.** The whole
decomposition was recomputed under all 3 non-empty subsets of
the 2 poolable engagement channels:

| composite definition | reverse | subjects |
|---|---|---|
| eye closure | 0 | (none) |
| gaze deviation (per-participant baseline) | 1 | S03 |
| eye closure + gaze deviation (per-participant baseline) **[baseline]** | 0 | (none) |

**2. 'Reverse' is a within-subject relative statement, not an absolute one,**
and how far each case travels across the definitions is itself the evidence:

S03 is reverse under **1 of 3** definitions (none of them the baseline), with a
baseline composite of +0.319, so this case rests on that single definition and is an artifact of that one choice.
S03 reported boredom 9/3/3 across Boring/Clinical/Interesting and engagement 7 on clinical.
...
|---|---|---|---|---|---|
| no prior exposure | 8 | 5.12 | 4.50 | 22.1 | 0.399 |
| prior exposure to medical footage | 4 | 6.00 | 4.25 | 21.2 | 0.174 |
...
| eye closure | BOR | +0.999 | +1.057 | +0.058 | yes |
| eye closure | CLC | -0.626 | -0.735 | -0.109 | yes |
| eye closure | INT | -0.373 | -0.322 | +0.052 | yes |
