...
to Spearman**, which is the point: it is a property of the design, not an artefact
of ranking.
...
Here the two agree closely - median |r - rho| = **0.032**, maximum **0.117**.
...
|---|---|---|---|---|---|---|---|---|---|
| gaze deviation median | boredom | 36 | **+0.524** | **0.0074** | 0.00105 | +0.574 | 0.0036 | 0.00025 | +0.050 |
| eye openness | boredom | 36 | **-0.460** | **0.0212** | 0.00481 | -0.577 | 0.0042 | 0.00023 | -0.117 |
| gaze deg from centre (v3) | boredom | 36 | +0.359 | 0.0751 | 0.03165 | +0.341 | 0.0954 | 0.04187 | -0.018 |
| % time >10 deg off centre (v3) | boredom | 36 | +0.324 | 0.1114 | 0.05363 | +0.346 | 0.0931 | 0.03845 | +0.022 |
| pupil dilation | boredom | 36 | -0.172 | 0.4037 | 0.31555 | -0.164 | 0.4334 | 0.33994 | +0.008 |
| gaze deviation variance | boredom | 36 | -0.114 | 0.5675 | 0.50683 | -0.105 | 0.6100 | 0.54338 | +0.010 |
...
| excursion rate >10 deg (v3) | boredom | 36 | -0.082 | 0.6829 | 0.63320 | -0.148 | 0.4675 | 0.38855 | -0.066 |
| gaze deg p90 (v3) | boredom | 36 | -0.046 | 0.8222 | 0.79199 | +0.000 | 0.9995 | 0.99959 | +0.046 |
| gaze deviation median | engagement | 36 | **-0.527** | **0.0075** | 0.00095 | -0.590 | 0.0030 | 0.00015 | -0.063 |
| eye openness | engagement | 36 | **+0.416** | **0.0370** | 0.01153 | +0.530 | 0.0077 | 0.00088 | +0.114 |
| gaze deg from centre (v3) | engagement | 36 | -0.391 | 0.0515 | 0.01832 | -0.403 | 0.0476 | 0.01474 | -0.012 |
| % time >10 deg off centre (v3) | engagement | 36 | -0.334 | 0.0990 | 0.04653 | -0.389 | 0.0570 | 0.01891 | -0.055 |
| excursion rate >10 deg (v3) | engagement | 36 | +0.184 | 0.3622 | 0.28173 | +0.216 | 0.2932 | 0.20530 | +0.032 |
| cognitive load | engagement | 36 | +0.107 | 0.5954 | 0.53277 | +0.097 | 0.6375 | 0.57342 | -0.010 |
| gaze deviation variance | engagement | 36 | +0.106 | 0.6073 | 0.53773 | +0.091 | 0.6632 | 0.59736 | -0.015 |
...
| gaze deg p90 (v3) | engagement | 36 | -0.033 | 0.8730 | 0.84914 | -0.088 | 0.6675 | 0.60923 | -0.055 |
...
- **gaze deg from centre (v3) vs boredom**: rho +0.359, analytic p 0.0317 -> permutation p 0.0751
- **gaze deg from centre (v3) vs engagement**: rho -0.391, analytic p 0.0183 -> permutation p 0.0515
- **% time >10 deg off centre (v3) vs engagement**: rho -0.334, analytic p 0.0465 -> permutation p 0.0990
