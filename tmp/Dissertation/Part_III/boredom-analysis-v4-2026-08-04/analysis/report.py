...
def _methods(ctx):
    ...
    A("where both exist, which is why the earlier conclusions were not artefacts of it.")
    A("")
...
def _criterion_appendix(ctx):
    ...
    A("to Spearman**, which is the point: it is a property of the design, not an artefact")
    A("of ranking.")
    A("")
