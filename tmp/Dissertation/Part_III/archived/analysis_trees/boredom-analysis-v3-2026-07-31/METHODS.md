...
Round 2 has no crop re-export, so its recordings are full-window: mean 1038.9 s, range 1013.2-1167.8 s. This is the origin of the non-wear artefact handled in section 5.
...
where both exist, which is why the earlier conclusions were not artefacts of it.
...
| `semantic` | a non-numeric answer carrying meaning (NA on minutes-until-bored means the subject never became bored - data, not absence) | 5 |
