...
**Application criterion.** Paragraph-scope methodology engages at step 1 of the §5.4 procedure: reading the source paragraph alongside the quote field is the operational entry point, chronologically prior to step-2 grounding-checks and step-4 sub-pattern classification. Reading the paragraph informs sub-pattern classification rather than being invoked atemporally as a co-equal procedure-step. Faithfulness=supported items short-circuit the §5.4 procedure per existing §5.4 framing and do not invoke paragraph-scope verification (faithfulness=supported assumes quote-grounded labeling without paragraph-context grounding-check requirements). Faithfulness=supported short-circuit framing reflects current §5.4 standing; revisable per item-25b sub-sessions B.4 / B.5 codification outcomes (faithfulness=partial vs supported §5.4 entry-criterion + faithfulness=supported reliability audit).
...
**Boundary specifications deferred to subsequent codifications.** The boundary between paragraph-scope (in-scope for §5.4) and chapter-arc-scope (out-of-scope for §5.4 sub-pattern (a) NON-FIRE licensing) is specified at item-25b sub-session B.2 codification (insertion location TBD at B.2 time). The cluster-vs-paragraph-scope verification methodology distinction is specified at item-25b sub-session B.7 codification (insertion location TBD at B.7 time).
...
| sub-pattern-(a)-paragraph-vs-chapter-arc-scope-boundary | ITEM-25 CANDIDATE | dev-23 Q1/Concern C | 1 | 2026-05-01 | B |
| sub-pattern-(c)-umbrella-vs-split-decision | ITEM-25 CANDIDATE | dev-21 Decision 19 / dev-22 Decision 22 | 3 variants (c-conditional dev-16 + c-causal dev-21 + c-parallel dev-22) | 2026-05-01 | B |
| faithfulness-partial-vs-supported-§5.4-entry-criterion | ITEM-25 CANDIDATE | dev-23 Q1 (first faithfulness=partial) | 1 | 2026-05-01 | B |
| faithfulness-supported-reliability-audit | ITEM-25 CANDIDATE | dev-20 Concern B | 6 (dev-17 + dev-19 + dev-20 + dev-22 + dev-24 supported-accommodation cumulative) | 2026-05-01 | B |
| DISAMBIGUATION-third-directionality-variant-(b-single) | ITEM-25 CANDIDATE | dev-23 Entry C | 1 | 2026-05-01 | B |
| cluster-level-vs-paragraph-scope-§5.4-verification-methodology | ITEM-25 CANDIDATE | dev-22 Entry B Q1 | 1 | 2026-05-01 | B |
| paraphrase-modifications-taxonomy-formalization | ITEM-25 CANDIDATE | dev-17 + dev-19 + dev-20 → dev-22 → dev-24 | 8 mechanisms cumulative (substitution / addition / omission / modal-shift / causal-frame-collapse / parallel-clause-drop / rhetorical-frame stripping / presupposition-to-assertion conversion) | 2026-05-01 | B |
...
| AF5-type-(4)-sub-variant-taxonomy-split-decision | ITEM-25 CANDIDATE | dev-15 Entry C / dev-19 Entry E | 4c n=4 + 4d n=3 (both at-or-past split-threshold per dev-22 Concern D criterion) | 2026-05-01 | C |
| AF4-load-bearing-modifier-tier-stratified-GENUINE-GAP-formalization | ITEM-25 CANDIDATE (provisional standing post-dev-21) | dev-9 → dev-19 Concern D → dev-21 Q5 | raw n=10 / verified n=4 (dev-19 + dev-20 + dev-21 + dev-23) | 2026-05-01 | C |
| AF5-4-disposition-taxonomy-specification | ITEM-25 CANDIDATE (provisional standing) | dev-15 Entry C | 4-disposition framework (tight-fire / loose-tracking / abstract-skip / no-elided-content-skip) | 2026-05-01 | C |
| SURFACE-DRIVEN-rule-scope-specification | ITEM-25 CANDIDATE (provisional standing) | dev-19 Decision 13 | applied dev-19/20/21/22/23/24 cumulative | 2026-05-01 | D |
| Audi-031-nominalization-rule-extension | PROVISIONAL APPLICATION | dev-21 (provisional fire) → dev-22 Entry H (formalization candidate) | dev-18 + dev-19 + dev-21 + dev-23 + dev-24 instances; flag applied retroactively at A.2 per §7.4 retroactive-flag-storage rule | 2026-05-01 | D |
| cross-word-semantic-synonymy-framework | ITEM-25 CANDIDATE | dev-16 Entry D → dev-21 Entry D → dev-22 Entry D | 3 instances (dev-16 noun-noun + dev-17 adj-adj + dev-21 verb-noun) with 3 distinct dispositions | 2026-05-01 | D |
| cross-author-collision-avoidance-sub-mechanism-distinction | ITEM-25 CANDIDATE | dev-12 (collision-flag-firing) → dev-21 Entry E (surface-driven-disambiguation) | 3 instances (dev-12 + dev-21 + dev-22) | 2026-05-01 | D |
| multi-cross-author-SURFACE-DRIVEN-DISAMBIGUATION-considerations | PROVISIONAL APPLICATION | dev-22 Entry C | 1 (dev-22 first ternary instance Audi+Kim+Barnes); flag applied retroactively at A.2 per §7.4 retroactive-flag-storage rule | 2026-05-01 | D |
