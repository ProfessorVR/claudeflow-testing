...
- **Review edit velocity.** Count CONVENTIONS-edit entries in `drift-log.md` since item 1 and observe the trend:
  - **Raw count > 15** suggests spec evolution is outpacing annotation work.
