...
2026-04-22 | observation | triggered by 007 | analogical-target-AF5 is structurally distinct from elided-contrast-AF5 (033); both currently flagged AF5. Pattern-watch: if ≥2 more analogical-target cases appear by item 20, consider splitting AF5 into AF5a (elided contrast) and AF5b (analogical target), with back-sweep of 033 and 007.

2026-04-22 | observation — additional slug-graveyard instance | triggered by claim-aristotle-da-3.3-033 | second slug-graveyard cluster discovered: opinion/belief/hupolepsis concept family (13 thin sibling slugs: belief, beliefs, conviction, doxa, doxastic state, doxastic states, doxazein, episteme, hupolepsis, hypolepsis, judgement, judgment, opinion, pistis — all "Concept introduced via [author]" with no Greek, no aliases, no cross-linking). Counts against the item-007 slug-graveyard pattern-watch trigger. Current total: 2 clusters observed (numerical duality from 007, opinion-family from 033); trigger fires at 3. One more instance by item 20 → promote to PL code via §7.1 governance.
