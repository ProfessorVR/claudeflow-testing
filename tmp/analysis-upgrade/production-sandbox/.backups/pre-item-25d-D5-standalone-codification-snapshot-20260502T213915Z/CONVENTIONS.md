...
**Multi-cross-author scope:** SURFACE-DRIVEN-DISAMBIGUATION extends to multi-author single-claim cases per dev-22 Entry C ternary scope (Audi+Kim+Barnes+Horgan partial-coverage). PROVISIONAL APPLICATION pending D.5 standalone codification at item-25d PHASE 2 step 2; Bundle 1 does NOT pre-commit multi-cross-author scope codification (forward-reference to D.5 only).
